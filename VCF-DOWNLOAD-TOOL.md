...
> `--component` 可選值（工具 `--help` 實測全集，case-insensitive）：VCENTER, SDDC_MANAGER_VCF,
> NSX_T_MANAGER, ESX_HOST, VRSLCM, VRA, VROPS, VRLI, VRNI, VSAN_OSA_WITNESS, VSAN_ESA_WITNESS,
> VSAN_FILE_SERVICES, VMTOOLS, VCFDT, VCF_OPS_CLOUD_PROXY, VIDB, HCX, VMRC, VRO, VSP,
> DEPOT_SERVICE, VCF_LICENSE_SERVER, TELEMETRY_ACCEPTOR, VCF_FLEET_LCM, VCF_SDDC_LCM,
> VCF_CONSUMPTION_CLI, VCF_CONSUMPTION_CLI_PLUGINS, VCFMS_METRICS_STORE,
> VCF_SERVICE_VCD_MIGRATION_BACKEND, VCF_SALT, VCF_SALT_RAAS, VCF_OBSERVABILITY_DATA_PLATFORM。
